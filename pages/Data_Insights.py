...
def plot_overall_feelings(df):
    try:
        ...
        Logger.error(f"Error plotting overall feelings: {e}")
        return None
...
def plot_sentiment_score_distribution(df):
    try:
        ...
        Logger.error(f"Error plotting sentiment score distribution: {e}")
        return None
...
def plot_product_sentiment(df):
    try:
        ...
        Logger.error(f"Error plotting product sentiment: {e}")
        return None
